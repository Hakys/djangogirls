...
urlpatterns = [
    ...
    #url(r'^productos/(?P<ref>.+)/actualizar/$', views.product_actualizar, name="product_actualizar"), 
    #url(r'^productos/(?P<ref>.+)/borrar/$', views.product_borrar, name="product_borrar"),
